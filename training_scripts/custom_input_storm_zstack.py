...
def read_data_sets(train_dir,
    ...
    DATA_DIR = '../training_data/storm_z/'

    TRAIN_IMAGES = DATA_DIR +'train_data_a647_zstack.mat'
    TRAIN_LABELS = DATA_DIR +'train_label_a647_zstack.mat'
    TEST_IMAGES = DATA_DIR + 'train_data_a647_zstack.mat'
    TEST_LABELS = DATA_DIR + 'train_label_a647_zstack.mat'
    train_images = extract_images_from_mat(TRAIN_IMAGES)
    train_labels = extract_labels_from_mat(TRAIN_LABELS)

    test_images = extract_images_from_mat(TEST_IMAGES)
    test_labels = extract_labels_from_mat(TEST_LABELS)
